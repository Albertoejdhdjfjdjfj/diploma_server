...
var decodeToken_1 = require("../../assets/functions/helpFunctions/decodeToken");
module.exports = function (context) { return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
        ...
        try {
            data = decodeToken_1.decodeToken(token);
            return [2 /*return*/, { nickname: data.nickname, playerId: data.userId }];
        }
        catch (error) {
