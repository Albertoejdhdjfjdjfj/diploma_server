...
var gameRoomResolver = {
    ...
    Mutation: {
        createGameRoom: function (_, args, player) { return __awaiter(void 0, void 0, Promise, function () {
            var name, userGames, newGame, error_2;
        ...
        joinGameRoom: function (_, args, player) { return __awaiter(void 0, void 0, Promise, function () {
            var id, gameRoom, userGames, joinGames, updatedGameRoom_1, updatedGameRoom, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, GameRoom_1.GameRoomModel.findOne({
                                "creator.creatorId": player.playerId
                            })];
                    case 2:
                        userGames = _a.sent();
                        return [4 /*yield*/, GameRoom_1.GameRoomModel.findOne({
                    ...
                    case 4:
                        updatedGameRoom_1 = _a.sent();
                        return [2 /*return*/, updatedGameRoom_1];
                    case 5:
        ...
        leaveGameRoom: function (_, args, context) { return __awaiter(void 0, void 0, Promise, function () {
            var user_1, id, gameRoom, playerIndex, updatedGameRoom, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        playerIndex = gameRoom.players.findIndex(function (player) { return player.playerId === user_1.id; });
                        if (playerIndex === -1) {
                            playerIndex = gameRoom.observers.findIndex(function (player) { return player.playerId === user_1.id; });
                            if (playerIndex === -1) {
